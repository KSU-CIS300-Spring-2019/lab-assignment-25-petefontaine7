...
namespace Ksu.Cis300.PriorityQueueLibrary
{
    ...
    {
        /// <summary>
        /// _nullPathLength holds the shortest length to an empty subtree.
        /// </summary>
        ...
        /// <summary>
        /// This gets the NullPathLength of a leftist tree.
        /// </summary>
        /// <param name="t"> t is the tree to be checked. </param>
        /// <returns> An int of null path length is returned. </returns>
